...
- [x] 002-A2 - Fix LFI/path traversal via locale cookie (Status: Done)
- [x] 003-A3 - Validate Host before redirect and URL building to prevent Host header injection and open redirect (Status: Done)
- [x] 004-A4 - Harden session cookies and session lifecycle (Status: Done)
- [x] 005-A5 - Harden Storage::setCookie and deleteCookie (Status: Done)
- [x] 006-A6 - Replace extension-only upload validation with MIME and storage hardening (Status: Done)
- [x] 007-A7 - Stop trusting proxy IP headers unconditionally (Status: Done)
- [x] 008-A8 - Add CSRF protection for state-changing routes (Status: Done)
- [x] 009-A9 - Implement real auth example and deny-by-default middleware (Status: Done)
- [x] 010-A10 - Block direct access to sensitive files (Status: Done)
- [x] 011-A11 - Do not leak internal errors to browsers (Status: Done)
- [x] 012-A12 - Add security headers (Status: Done)
- [x] 013-A13 - Move rate limiting off session to survive cookie clear and multi-server (Status: Done)
- [x] 014-A14 - Sanitize output at render, not input at read (Status: Done)
- [x] 015-B1 - Ensure System::complete() always runs even when code calls exit or die (Status: Done)
...
- [x] 023-B9 - Fix LazyLoad uninitialized state and loose key matching (Status: Done)
- [x] 024-B10 - Fix SessionRateLimiter prune-on-block bug and key collision (Status: Done)
...
- [x] 028-B14 - Return proper API responses with headers and status (Status: Done)
- [x] 029-B15 - Fix Controller::view error contract (Status: Done)
...
- [x] 032-B18 - Replace insecure ID generators with random_bytes (Status: Done)
- [x] 033-B19 - Fix Vite helper HMR edge case (Status: Done)
...
- [x] 036-C3 - Introduce a real Request and Response pipeline (Status: Done)
- [x] 037-C4 - Replace CMS constant includes and installer.zip with explicit package or env flag (Status: Done)
- [x] 038-C5 - Namespace global helpers and avoid __ collision (Status: Done)
- [x] 039-C6 - Validate config shape at bootstrap (Status: Done)
- [x] 040-C7 - Document string-based Controller at method dispatch with safety checks (Status: Done)
- [x] 041-C8 - Clarify cache and event usage because they are shipped but unwired (Status: Done)
- [x] 042-D1 - Do not force debugMode(false) globally (Status: Done)
- [x] 043-D2 - Add migration, seeder, and transaction story to core instead of docs-only (Status: Done)
- [x] 044-D3 - Define model mass-assignment and type rules (Status: Done)
- [x] 045-D4 - Optimize LazyLoad from O(n*m) filter to keyed map (Status: Done)
- [x] 046-E1 - Stop wiping assets blindly and separate uploads from build output (Status: Done)
- [x] 047-E2 - Version CSS and JS consistently (Status: Done)
- [x] 048-E3 - Document Vite proxy limits (Status: Done)
...
- [x] 051-F3 - Fix Docker credentials drift and add healthchecks (Status: Done)
- [x] 052-F4 - Do not bind-mount entire repo in a prod-like compose without note (Status: Done)
- [x] 053-F5 - Remove or replace installer.zip binary in git (Status: Done)
- [x] 054-F6 - Add Apache hardening for prod (Status: Done)
...
- [x] 057-G3 - Add static analysis and style checks (Status: Done)
- [x] 058-G4 - Add CI for app code, not just docs FTP (Status: Done)
- [x] 059-G5 - Standardize 404 and error pages with correct status codes (Status: Done)
- [x] 060-G6 - Tighten Composer version constraints deliberately (Status: Done)
- [x] 061-H1 - Fix README typos and broken paths (Status: Done)
- [x] 062-H2 - Keep single source for architecture to avoid drift (Status: Done)
- [x] 063-H3 - Correct contradictory validator example (Status: Done)
- [x] 064-H4 - Document request helper nuances and file upload flow end to end (Status: Done)
- [x] 065-H5 - Document middleware attachment, rate limiter reset, and i18n fallback (Status: Done)
- [x] 066-H6 - Add missing repo hygiene files (Status: Done)
- [x] 067-H7 - Clarify frontend workflow commands (Status: Done)
