...
<div class="block-header-container">
    <div class="block-header-primary">
        ...
        <p class="block-header-subtitle">
            <a href="<?= url($form_data->slug) ?>" target="_blank">
                <?= url($form_data->slug) ?> <i class="iconoir-open-new-window"></i>
            </a>
        </p>
        <?php endif; ?>
    </div>
    ...
    <div class="block-header-secondary">
        <button data-url="<?= route('admin.pages.destroy', ['param' => $form_data->id]) ?>"
            class="button button-danger button-text" id="delete-button">Delete permanently</button>
    </div>
    <?php endif; ?>
</div>
<!-- block header container -->
...
<form action="<?= $form_action_url ?>" method="<?= $form_action_url_method ?>" class="form" data-ajax="true">
    <div class="form-field">
        ...
        <input type="text" name="title" id="title" class="form-input"
            value="<?= !is_null($form_data) ? $form_data->title : '' ?>">
    </div>
    ...
    <div class="form-field">
        ...
        <div class="form-radio-items">
            <?php if ($form_data) : ?>
            <label class="form-radio-item"><input type="radio" name="type" class="form-radio" value="page" <?php if
                    ($form_data->type == 'page') echo 'checked' ?>> Page</label>
            <label class="form-radio-item"><input type="radio" name="type" class="form-radio" value="blog" <?php if
                    ($form_data->type == 'blog') echo 'checked' ?>> Blog</label>
            <?php else: ?>
            <label class="form-radio-item"><input type="radio" name="type" class="form-radio" value="page" checked>
                Page</label>
    ...
    <div class="form-field form-field--editor">
        ...
        <div class="form__editor-value" data-input-name="body" style="display: none;">
            <?= !is_null($form_data) ? $form_data->body : '' ?>
        </div>
    </div>
    ...
    <div class="form-field">
        ...
        <select name="category_id[]" id="category_id" class="form-select" multiple>
            ...
            <option value="<?= $category->id ?>" <?=\App\Utils\_::contains($form_data->category_ids, $category->id) ? '
                selected' : '' ?>>
                <?= $category->name ?>
            </option>
            <?php endforeach; ?>
